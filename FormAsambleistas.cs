...
namespace Asambleistas
{
    public partial class FormAsambleistas : Form
    {
        ...
        private void MostrarInformacion(string partido)
        {
            ...
            {
                case "ID12":
                    pbx_infoPartido.Load("https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Izquierda_democratica_2018.png/150px-Izquierda_democratica_2018.png");
                    ...
                    break;
                case "CD 1":
                    pbx_infoPartido.Load("https://upload.wikimedia.org/wikipedia/commons/0/04/Centro_democratico_ecuador.png");
                    ...
                    break;
                case "MUPP":
                    pbx_infoPartido.Load("https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Pachakutik.svg/200px-Pachakutik.svg.png");
                    ...
                    break;
                case "PSC":
                    pbx_infoPartido.Load("https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Partido_Social_Cristiano_01.svg/200px-Partido_Social_Cristiano_01.svg.png");
